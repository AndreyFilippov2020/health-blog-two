...
<head>
    ...
    <meta name="description" content="{{  $metaDescription ?: 'My blog Description' }}">
...
<nav class="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
    ...
    <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
        <div
            ...
            <a href="{{ route('home') }}" class="hover:bg-blue-700 hover:text-white rounded py-2 px-4 mx-2">Home</a>
